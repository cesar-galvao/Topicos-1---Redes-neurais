...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# VERIFICAR A CONTA AQUI NO FINAL E PASSAR PARA MATRICIAL}
...
\NormalTok{grad\_item\_d }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{as\_tibble}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{reframe}\NormalTok{(}\AttributeTok{Componente =} \FunctionTok{c}\NormalTok{(}\StringTok{"w1"}\NormalTok{, }\StringTok{"w2"}\NormalTok{, }\StringTok{"w3"}\NormalTok{, }\StringTok{"w4"}\NormalTok{, }\StringTok{"w5"}\NormalTok{, }\StringTok{"w6"}\NormalTok{, }\StringTok{"b1"}\NormalTok{, }\StringTok{"b2"}\NormalTok{, }\StringTok{"b3"}\NormalTok{),}
         \AttributeTok{Derivada =}\NormalTok{ value) }\SpecialCharTok{\%\textgreater{}\%}
...
\captionsetup{labelsep=none}\includegraphics{lista1-resolucao_files/figure-pdf/fig-esperado-observado-1.pdf}
...
\captionsetup{labelsep=none}\includegraphics{lista1-resolucao_files/figure-pdf/fig-gradientek-1.pdf}
...
\phantomsection\label{tbl-MSE}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{Modelo =} \FunctionTok{c}\NormalTok{(}\StringTok{"Rede Neural"}\NormalTok{, }\StringTok{"Modelo Linear 1"}\NormalTok{, }\StringTok{"Modelo Linear 2"}\NormalTok{),}
  \AttributeTok{MSE =} \FunctionTok{c}\NormalTok{(}\FunctionTok{min}\NormalTok{(back\_validacao}\SpecialCharTok{$}\NormalTok{loss\_history), MSE1, MSE2)}
\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{MSE =} \FunctionTok{round}\NormalTok{(MSE, }\DecValTok{2}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
