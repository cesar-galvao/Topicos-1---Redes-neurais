...
\NormalTok{efeitos\_x1 }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  ...
  \AttributeTok{x2 =} \FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{100}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{yhat =} \FunctionTok{ffwd}\NormalTok{(., back\_validacao}\SpecialCharTok{$}\NormalTok{best\_theta)}\SpecialCharTok{$}\NormalTok{yhat)}
\end{Highlighting}
\end{Shaded}
