...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# usamos o melhor theta encontrado}
\NormalTok{theta }\OtherTok{\textless{}{-}}\NormalTok{ back\_validacao}\SpecialCharTok{$}\NormalTok{best\_theta}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{efeitos\_x1 }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{x1 =} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{3}\NormalTok{, }\DecValTok{3}\NormalTok{, }\AttributeTok{length.out =} \DecValTok{100}\NormalTok{),}
  \AttributeTok{x20 =} \FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{100}\NormalTok{),}
  \AttributeTok{x215 =} \FunctionTok{rep}\NormalTok{(}\FloatTok{1.5}\NormalTok{, }\DecValTok{100}\NormalTok{),}
  \AttributeTok{x2\_15 =} \FunctionTok{rep}\NormalTok{(}\SpecialCharTok{{-}}\FloatTok{1.5}\NormalTok{, }\DecValTok{100}\NormalTok{),}
  \AttributeTok{x23 =} \FunctionTok{rep}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{100}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{yhat0 =} \FunctionTok{ffwd}\NormalTok{(.[,}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{)], back\_validacao}\SpecialCharTok{$}\NormalTok{best\_theta)}\SpecialCharTok{$}\NormalTok{yhat,}
         \AttributeTok{yhat15 =} \FunctionTok{ffwd}\NormalTok{(.[,}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{)], back\_validacao}\SpecialCharTok{$}\NormalTok{best\_theta)}\SpecialCharTok{$}\NormalTok{yhat,}
         \AttributeTok{yhat15\_ =} \FunctionTok{ffwd}\NormalTok{(.[,}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{4}\NormalTok{)], back\_validacao}\SpecialCharTok{$}\NormalTok{best\_theta)}\SpecialCharTok{$}\NormalTok{yhat,}
         \AttributeTok{yhat3 =} \FunctionTok{ffwd}\NormalTok{(.[,}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{5}\NormalTok{)], back\_validacao}\SpecialCharTok{$}\NormalTok{best\_theta)}\SpecialCharTok{$}\NormalTok{yhat) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(x1, yhat0, yhat15, yhat15\_, yhat3) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{pivot\_longer}\NormalTok{(}\AttributeTok{cols =} \SpecialCharTok{{-}}\NormalTok{x1, }\AttributeTok{names\_to =} \StringTok{"x2"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"yhat"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{x2 =} \FunctionTok{case\_when}\NormalTok{(}
\NormalTok{    x2 }\SpecialCharTok{==} \StringTok{"yhat0"} \SpecialCharTok{\textasciitilde{}} \StringTok{\textquotesingle{}0\textquotesingle{}}\NormalTok{,}
\NormalTok{    x2 }\SpecialCharTok{==} \StringTok{"yhat15"} \SpecialCharTok{\textasciitilde{}} \StringTok{\textquotesingle{}1.5\textquotesingle{}}\NormalTok{,}
\NormalTok{    x2 }\SpecialCharTok{==} \StringTok{"yhat15\_"} \SpecialCharTok{\textasciitilde{}} \StringTok{\textquotesingle{}{-}1.5\textquotesingle{}}\NormalTok{,}
\NormalTok{    x2 }\SpecialCharTok{==} \StringTok{"yhat3"} \SpecialCharTok{\textasciitilde{}} \StringTok{\textquotesingle{}3\textquotesingle{}}
\NormalTok{    )}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{lista1-resolucao_files/figure-pdf/fig-efeitox1-1.pdf}
...
\NormalTok{tabela\_withinrn }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{yhat =} \FunctionTok{ffwd}\NormalTok{(dados\_test[,}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{)], back\_validacao}\SpecialCharTok{$}\NormalTok{best\_theta)}\SpecialCharTok{$}\NormalTok{yhat, }\CommentTok{\#usamos o melhor theta da validação}
  \AttributeTok{sigma =} \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{min}\NormalTok{(back\_validacao}\SpecialCharTok{$}\NormalTok{loss\_history)), }\CommentTok{\#usamos o minimo da loss da validação}
...
\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{lower =}\NormalTok{ yhat }\SpecialCharTok{{-}} \FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{)}\SpecialCharTok{*}\NormalTok{sigma,}
    \AttributeTok{upper =}\NormalTok{ yhat }\SpecialCharTok{+} \FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{)}\SpecialCharTok{*}\NormalTok{sigma,}
...
\NormalTok{plot\_regressao }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(tabela, }\FunctionTok{aes}\NormalTok{(x1, x2, }\AttributeTok{color =}\NormalTok{ within))}\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{,}\StringTok{"green"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
